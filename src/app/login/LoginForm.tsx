...
import { validateLoginForm, friendlyAuthError, resolveLoginRedirect, type LoginFormErrors } from '@/lib/auth-validation';
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 md:p-8 card-bubble flex flex-col gap-4">
            ...
            <p className="text-center text-sm" style={{ color: 'var(--blush-muted)' }}>
                New to Charm Avenue?{' '}
                <Link href="/signup" className="font-bold hover:underline" style={{ color: 'var(--blush-rose)' }}>
                    Create an account
                </Link>
            </p>
        </form>
