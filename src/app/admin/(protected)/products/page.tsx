                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-bold tracking-tight truncate text-[0.9375rem]" style={{ color: 'var(--blush-text)' }}>{product.name}</p>
                                    <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                                        <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium" style={{ background: 'var(--blush-bg)', color: 'var(--blush-muted)' }}>
                                        ...
                                        <span
                                            ...
                                            style={
                                                product.is_active
                                                    ? { background: '#E8F5E9', color: '#2E7D32', border: '1px solid rgba(46,125,50,0.16)' }
                                                    : { background: '#EFE6E2', color: '#8A7A75', border: '1px solid rgba(138,122,117,0.18)' }
                                            }
                                        >
                                            <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ background: product.is_active ? '#2E7D32' : '#8A7A75' }} />
                                            {product.is_active ? 'Live' : 'Hidden'}
                                        </span>
                                    </div>
                                    <p className="mt-1.5">
                                        <span className="font-elegant-serif font-semibold text-sm" style={{ color: 'var(--blush-text)' }}>₹{product.price}</span>
                    ...
                    <table className="w-full min-w-[760px] text-left text-sm">
                        <thead>
                            <tr style={{ background: 'var(--blush-bg)' }}>
                                ...
                                <th className="px-5 py-3.5 font-bold text-[11px] uppercase tracking-wide" style={{ color: 'var(--blush-muted)' }}>Product</th>
                                <th className="px-5 py-3.5 font-bold text-[11px] uppercase tracking-wide" style={{ color: 'var(--blush-muted)' }}>Category</th>
                                <th className="px-5 py-3.5 font-bold text-[11px] uppercase tracking-wide" style={{ color: 'var(--blush-muted)' }}>Price</th>
                                <th className="px-5 py-3.5 font-bold text-[11px] uppercase tracking-wide" style={{ color: 'var(--blush-muted)' }}>Status</th>
                                <th className="px-5 py-3.5 font-bold text-[11px] uppercase tracking-wide text-right" style={{ color: 'var(--blush-muted)' }}>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {list.map((product, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-4 font-bold tracking-tight text-[0.9375rem]" style={{ color: 'var(--blush-text)' }}>{product.name}</td>
                                        ...
                                        <td className="px-5 py-4">
                                            <span className="font-elegant-serif font-semibold" style={{ color: 'var(--blush-text)' }}>₹{product.price}</span>
                                            {product.original_price && (
                                                <span className="text-xs line-through ml-1.5" style={{ color: 'var(--blush-muted)' }}>₹{product.original_price}</span>
                                            )}
                                        </td>
