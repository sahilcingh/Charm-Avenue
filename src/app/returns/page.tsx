...
const sections = [
  {
    ...
    body: (
      <p>
        All products are non-returnable and non-exchangeable. Please check the product details
  ...
  },
  {
    ...
    body: (
      <p>
        Since we&apos;re unable to accept returns or exchanges, we&apos;d love for you to take a
        moment to review the size, colour and description of each item before checking out.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        Not sure if a piece is right for you? Reach out on our Contact page before placing your
