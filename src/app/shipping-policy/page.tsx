...
const sections = [
  {
    ...
    body: (
      <p>
        We currently accept prepaid orders only. Cash on Delivery (COD) is not available at this
        time.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        Every order is carefully packed with secure and protective packaging to ensure your products
        reach you safely.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        Orders are dispatched after successful payment confirmation. Delivery timelines may vary
  ...
  },
  {
    ...
    body: (
      <p>
        Once your order ships, you&apos;ll receive a tracking link by email/SMS so you can follow it
  ...
  },
  {
    ...
    body: (
      <p>
        Reach out any time on our Contact page and we&apos;ll help sort out delivery questions
        quickly.
      </p>
    ),
  },
