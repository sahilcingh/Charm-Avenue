        ...
        <div className="flex flex-col gap-4">
            <div className="bg-white rounded-3xl p-6 card-bubble flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <span className="text-xs truncate block" style={{ color: 'var(--blush-muted)' }}>{email}</span>
                    {nameError && <p className="text-xs mt-1" style={{ color: 'var(--blush-rose-dark)' }}>{nameError}</p>}
                </div>
