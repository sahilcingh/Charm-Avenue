    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="bg-white rounded-3xl p-6 md:p-8 card-bubble flex flex-col gap-4">
                <h3 className="font-elegant-serif text-lg" style={{ color: 'var(--blush-text)' }}>Order History</h3>
                {orders.length === 0 ? (
                    <p className="text-sm" style={{ color: 'var(--blush-muted)' }}>You haven&apos;t placed any orders yet.</p>
                ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                <form onSubmit={handleContactSubmit} className="bg-white rounded-3xl p-6 md:p-8 card-bubble flex flex-col gap-4">
                    <div>
                        <h3 className="font-elegant-serif text-lg" style={{ color: 'var(--blush-text)' }}>Delivery Details</h3>
                        <p className="text-xs mt-0.5" style={{ color: 'var(--blush-muted)' }}>
                            Saved here, so checkout can pre-fill them next time.
                        </p>
                    </div>
                    <div>
                        <label className="text-xs font-bold uppercase tracking-wide mb-1.5 block" style={{ color: 'var(--blush-text)' }}>Phone Number</label>
                        <input
                            type="tel"
                            value={contact.phone}
                    ...
                    <div>
                        <label className="text-xs font-bold uppercase tracking-wide mb-1.5 block" style={{ color: 'var(--blush-text)' }}>Delivery Address</label>
                        <textarea
                    ...
                    {contactError && <p className="text-sm font-medium" style={{ color: 'var(--blush-rose-dark)' }}>{contactError}</p>}
                    <button
                        type="submit"
