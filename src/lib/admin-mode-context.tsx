 ...
 */
export function resolveAdminModeState({ isAdmin, storedPreference }: { isAdmin: boolean; storedPreference: boolean }): boolean {
...
export function AdminModeProvider({ children }: { children: React.ReactNode }) {
    ...
    const value = useMemo(() => ({ isAdmin, adminModeOn, toggleAdminMode }), [isAdmin, adminModeOn, toggleAdminMode]);
